...
router.post('/', async (req, res) => {
  const { 
    ...
    telephone, website, productionvolumes, keycustomers, region, foundingyear, keymanagement, rate, offeringproducts, customerneeds, technologyuse, competitiveadvantage, challenges
  } = req.body;
  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO companies (
        name, email, headquarters_location, r_and_d_location, country, product, employeestrength, revenues, 
        telephone, website, productionvolumes, keycustomers, region, foundingyear, keymanagement, rate, offeringproducts, customerneeds, offeringproducts, customerneeds, technologyuse, competitiveadvantage, challenges
      ) VALUES (
